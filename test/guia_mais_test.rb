...
class GuiaMaisTest < Test::Unit::TestCase
  def test_se_funciona_com_32222222_RN
    cliente = GuiaMais::Cliente.buscar("32222222", :rio_grande_do_norte)
  ...
  def test_se_funciona_com_32222222_PI
    cliente = GuiaMais::Cliente.buscar("32222222", :piaui)
  ...
  def test_se_funciona_com_32222222_AP
    cliente = GuiaMais::Cliente.buscar("32222222", :amapa)
  ...
  def test_se_funciona_com_32325151_PI
    cliente = GuiaMais::Cliente.buscar("32325151", :piaui)
  ...
  def test_se_funciona_com_32321311_PI
    cliente = GuiaMais::Cliente.buscar("32321311", :piaui)
